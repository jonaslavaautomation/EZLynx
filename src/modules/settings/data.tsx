...
const SCHEMA: Record<TableName, Record<string, ColSpec>> = {
  accounts: { ...BASE, first_name: 'text', last_name: 'text', email: 'text', phone: 'text', address: 'text', city: 'text', state: 'text', zip: 'text', policy_type: 'text', status: 'text', account_type: 'text', business_name: 'text', dob: 'date', marital_status: 'text', occupation: 'text', mobile_phone: 'text', producer: 'text', csr: 'text', lead_source: 'text', notes: 'text', labels: ['json', []], customer_since: 'date', naics_code: 'text', sic_code: 'text', nature_of_business: 'text', naics_description: 'text', operations_description: 'text', prefix: 'text', middle_initial: 'text', suffix: 'text', maiden_name: 'text', nickname: 'text', gender: 'text', ssn_last4: 'text', dl_number: 'text', dl_status: 'text', dl_state: 'text', education: 'text', industry: 'text', occupation_years: 'int', prior_employer_years: 'int', account_name: 'text', preferred_language: 'text', vip: ['bool', false], phones: ['json', []], emails: ['json', []], bridge_email: ['bool', false], contact_method: 'text', contact_time: 'text', phone_ext: 'text', fax: 'text', website: 'text', legal_entity_type: 'text', tax_id: 'text', gl_code: 'text', date_business_started: 'date', lead_priority: 'text', probability_of_sale: 'int', lead_status: 'text' },
  ...
  account_addresses: { ...BASE, account_id: 'uuid', address_type: ['text', 'Mailing'], street: 'text', street2: 'text', city: 'text', state: 'text', zip: 'text', country: 'text', is_primary: ['bool', false], county: 'text', zip_suffix: 'text', unit: 'text', years_at_address: 'int', months_at_address: 'int' },
  user_settings: { ...BASE, staff_name: 'text', first_name: 'text', middle_initial: 'text', last_name: 'text', email: 'text', phone: 'text', mobile_phone: 'text', role_detail: 'text', preferences: ['json', {}], acord: ['json', {}], email_signature: 'text', reply_to: 'text', signature_insert: ['text', 'smart_tag'], signature_global_default: ['bool', false], display_global: ['bool', false], password_hash: 'text', password_salt: 'text', password_updated_at: 'ts', totp_secret: 'text', totp_enabled: ['bool', false] },
  login_events: { ...BASE, staff_name: 'text', event: 'text', ip: 'text', user_agent: 'text', trusted: ['bool', false] },
  account_contacts: { ...BASE, account_id: 'uuid', first_name: 'text', last_name: 'text', title: 'text', relationship: 'text', email: 'text', phone: 'text', mobile_phone: 'text', dob: 'date', is_primary: ['bool', false], is_secondary: ['bool', false], client_center_access: ['bool', false], address: 'text', city: 'text', state: 'text', zip: 'text' },
};
